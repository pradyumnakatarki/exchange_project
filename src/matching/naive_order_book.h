...
public:
  ...
  std::span<const Event> cancel_order(core::OrderId order_id,
                                      core::Timestamp timestamp = 0) noexcept {
    reset_events();
...
private:
  ...
  void replenish_iceberg(Order &order, core::Timestamp event_timestamp) noexcept {
  ...
  void match_fifo_at_level(Order &aggressor, Level &level,
                           ...
                           core::Price &last_fill_price) noexcept {
  ...
  void erase_stop_reference(const Order &order) noexcept {
  ...
  void reduce_order_quantity(Order &order, core::Quantity new_qty,
                             core::Timestamp event_timestamp) noexcept {
  ...
  void emit_reduced(core::Timestamp timestamp, core::OrderId order_id,
                    core::Quantity new_qty) noexcept {
  ...
  void emit_rested(core::Timestamp timestamp, const Order &order) noexcept {
  ...
  void emit_trade(core::Timestamp timestamp, const Order &aggressor,
                  const Order &passive, core::Price price,
  ...
  void emit_canceled(core::Timestamp timestamp, core::OrderId order_id,
                     core::Quantity canceled_qty) noexcept {
  ...
  void emit_accepted(core::Timestamp timestamp, const Order &order) noexcept {
