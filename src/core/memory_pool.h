...
namespace exchange::core {
    ...
    class MemoryPool {
        static_assert(N > 0, "MemoryPool size must be greater than 0");
        static_assert(sizeof(T) >= sizeof(void*), "MemoryPool element size must be at least the size of a pointer");
